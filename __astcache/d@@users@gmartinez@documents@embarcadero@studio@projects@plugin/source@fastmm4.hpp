...
// (DO NOT EDIT: machine generated header) 'FastMM4.pas' rev: 35.00 (Windows)
...
enum DECLSPEC_DENUM TFastMM_MemoryManagerInstallationState : unsigned char { mmisDefaultMemoryManagerInUse, mmisOtherThirdPartyMemoryManagerInstalled, mmisUsingSharedMemoryManager, mmisInstalled };
...
extern DELPHI_PACKAGE TRegisteredMemoryLeaks __fastcall GetRegisteredMemoryLeaks();
...
extern DELPHI_PACKAGE TMemoryManagerUsageSummary __fastcall GetMemoryManagerUsageSummary()/* overload */;
extern DELPHI_PACKAGE void __fastcall GetMemoryManagerUsageSummary(TMemoryManagerUsageSummary &AMemoryManagerUsageSummary)/* overload */;
...
extern DELPHI_PACKAGE TFastMM_MemoryManagerInstallationState __fastcall FastMM_GetInstallationState();
extern DELPHI_PACKAGE bool __fastcall CheckCanInstallMemoryManager();
extern DELPHI_PACKAGE void __fastcall InitializeMemoryManager();
extern DELPHI_PACKAGE void __fastcall InstallMemoryManager();
extern DELPHI_PACKAGE void __fastcall FinalizeMemoryManager();
