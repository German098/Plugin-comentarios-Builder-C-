...
class TPBrepData
{
  public:
	...
	bool CopyPBrep( IwPolyBrep *pbrepCopy, bool updateuvandtexcoords = false );
	...
	bool GetDisjointGroupEdges( TOGLTransf *OGLTransf, vector<vector<int> > *groups, bool extend = false, bool allEdges = false, IwTA<IwPolyEdge *> *edges = 0 );
	...
	bool GetShortPathBetweenFaces( TOGLTransf *OGLTransf, int indexFaceStart, int indexFaceEnd );
	...
	bool InitVertexFromArea( TOGLTransf *OGLTransf, IwTA<IwPolyVertex *> *vertex, double area, TProportionalEditingType type, int *nElem, int **idElem, T3DPoint **points );
	...
	bool CreateFaceFromCurrentMeshElementList( TOGLTransf *OGLTransf, IwTA<TMeshElementInfo> *elements, IwTA<IwPolyFace *> *faces = 0, bool retopologize = false, ULONG userIndex = 0 );
	...
	bool TranslateSelectedVertexs( TOGLTransf *OGLTransf, float incrX, float incrY, float incrZ, bool updateOGLList = true, bool slideVertexs = false );
	...
	// Inset
	bool InsetSelectedFaces( TOGLTransf *OGLTransf, float incrX, float incrY, float incrZ, int type, int sign, bool createFaces, bool normalizeDirs, bool updateOGLList = true );
	...
	void UpdateOGLListFromPBrep( TOGLTransf *OGLTransf, TOGLPolygonList *OGLList, bool checkSelected = false, bool calcnormals = false, bool updatetexcoords = false, bool recalcTopology = false );
  ...
  public:
	// --
	// Subdivision
	int GetSubdividedOGLList( TOGLTransf *OGLTransf, TOGLPolygonList *ogllist, TOGLPolygon *ogllistVertex, TOGLPolygon *ogllistEdges, TOGLPolygon *ogllistFaces, TSubdivisionData *subdivisiondata, TInteger_ListList *auxinfolist = 0 );
	...
	//	// QuadRemesher
	//	void UpdatePBrepFromQuadRemesher( TOGLTransf *OGLTransf, QRLib_Mesh *qrMesh, double vertexTol = RES_COMP );
	//	bool Remesh( TOGLTransf *OGLTransf, QRLib_RemeshSettings *remeshSettings, TCadGroup *curvesGroup, int curvesType, TcxProgressBar *cxProgressBar );
  ...
  private:
	...
	void GetCreaseAndSeamEdgesFromVertex( IwPoint3d iwPoint3d /*IwPolyVertex *vertex*/, IwTA<IwPolyEdge *> *creaseAndSeamEdgesFromVertex, IwTA<IwPolyEdge *> &creaseEdges, IwTA<IwPolyEdge *> &seamEdges );
  ...
  private:
	...
	IwPolyFace *GetUniqueFaceFromVertices( IwTA<IwPolyVertex *> liwVertices );
  ...
  public:
	...
	bool FacesToRemoveVertex( TOGLTransf *OGLTransf, IwPolyVertex *vertexToDelete, IwPolyVertex *vertexToKeep, IwTA<IwPolyFace *> *faces, IwTA<IwTA<IwPolyFace *> > *facesR );
  ...
  public:
	...
	void SplitFace( TOGLTransf *OGLTransf, IwPolyFace *iwFace, IwPolyEdge *iwEdge, IwPolyVertex *iwVertex, TAddedElements *addedElements = NULL, bool updateTopology = true );
